...
tmux set -g '@LOCAL_LOG' "/tmp/new-gruv.log"

## initialize developer log file for this plugins
[[ ! -f "$LOG" ]] && echo "tmux-new-gruv logfile" > "$LOG"
LOG="/tmp/tmux-new-gruv.log"
...
tmux bind C-t run "$LOCAL_ROOT/scripts/tmux-new-gruv.sh "

## run main plugin script
tmux run "$LOCAL_ROOT/scripts/tmux-new-gruv.sh "
